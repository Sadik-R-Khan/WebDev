...
class BMICalculator {
    ...
    setupEventListeners() {
        [this.heightInput, this.weightInput, this.feetInput, this.inchesInput].forEach(input => {
            if (input) {
    ...
    toggleHeightInputs() {
        ...
        this.heightInput.style.display = isFeetInches ? 'none' : 'block';
        this.feetInchesGroup.style.display = isFeetInches ? 'flex' : 'none';
    }
